...
module.exports = client => {
    client.on("ready", () => {
        let milratoGuild = client.guilds.cache.get("914099997639868417")
        ...
        app.post("/createbot", checkAuth, async (req, res) => {
            try {
                ...
                let BotType = "Default";
                let BotDir = "Default";
                if (ticketChannel.parentId == "952581586690396210") {
                    BotType = "System Bot";
                    BotDir = "SYSTEMBOTS";
                }
                if (ticketChannel.parentId == "952581551349190676") {
                    BotType = "Music Bot";
                    BotDir = "MusicBots";
                }
                ...
                let destDir = `/home/container/servicebots/${BotDir}/${filename}`;
                ...
                try {
                    ...
                    if (res) {
                        ...
                        destDir = `/home/container/servicebots/${BotDir}/${filename}`;
                ...
                setTimeout(async () => {
                    const srcDir = `/home/container/servicebots/${BotDir}/template`;
                    const destDir = `/home/container/servicebots/${BotDir}/${filename}`;
        ...
        app.listen(20233, () => {
            console.log(`[${client.config.callback.replace("/callback", "").replace("https://", "http://")}]: HTTP-Website running on 20233 port.`)
        });
    })
