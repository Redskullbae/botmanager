...
module.exports = client => {
    var webConfig = {
        ...
        https: {
            enabled: true,
            Port: 443,
            key: "/etc/letsencrypt/live/pay.kooje.me/privkey.pem",
            cert: "/etc/letsencrypt/live/pay.kooje.me/fullchain.pem",
            chain: "/etc/letsencrypt/live/pay.kooje.me/chain.pem",
        },
        domain: `https://pay.kooje.me`,
