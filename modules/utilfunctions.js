...
function theDB(client, guild) {
    ...
    **Please tell us all of those Informations!** | Otherwise, we can't create your Bot quickly!
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 1. \` What should be the Bot Name?**
    > *(The Bot's Username)*
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 2. \` What should be the PREFIX?**
    > *(The Letter(s) Infront of each Command, e.g: \`!\`)*
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 3. \` What should be the AVATAR?**
    > *(The Bot's Profile Picture)*
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 4. \` What should be the EMBED COLOR?**
    > *(The Color on the Left Side of Embeds)*
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 5. \` What should be the STATUS?**
    > *(e.g: \`!help | dsc.gg/cyberdev\`)*
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 6. \` What should be the STATUS TYPE?** 
    > *(\`PLAYING\` / \`WATCHING\` / \`LISTENING\` / \`STREAMING\` / \`COMPETING\`)*
    > 
    <a:right_arrow_yellow:947541936762388590> Do you have any wishes?
    ...
    *Someone will help you soon*`,
    ...
    client.setups.set(guild.id, {
        enabled: true,
        guildid: guild.id,
        parentid: "952581578561822750",
        message: `Hey {user}! Thanks for ordering a **Rythm Clone**

    **Please tell us all of those Informations!** | Otherwise, we can't create your Bot quickly!
    > 
    > 9389142823331<a:right_arrow_yellow:947541936762388590>47257 **\` 1. \` What should be the Bot Name?**
    > *(The Bot's Username)*
    > 
    > 9389142823331<a:right_arrow_yellow:947541936762388590>47257 **\` 2. \` What should be the PREFIX?**
    > *(The Letter(s) Infront of each Command, e.g: \`!\`)*
    > 
    > 9389142823331<a:right_arrow_yellow:947541936762388590>47257 **\` 3. \` What should be the AVATAR?**
    > *(The Bot's Profile Picture)*
    > 
    > 9389142823331<a:right_arrow_yellow:947541936762388590>47257 **\` 4. \` What should be the EMBED COLOR?**
    > *(The Color on the Left Side of Embeds)*
    > 
    > 9389142823331<a:right_arrow_yellow:947541936762388590>47257 **\` 5. \` What should be the STATUS?**
    > *(e.g: \`!help | .gg/milrato\`)*
    > 
    > 9389142823331<a:right_arrow_yellow:947541936762388590>47257 **\` 6. \` What should be the STATUS TYPE?** 
    > *(\`PLAYING\` / \`WATCHING\` / \`LISTENING\` / \`STREAMING\` / \`COMPETING\`)*
    > 
    > 9389142823331<a:right_arrow_yellow:947541936762388590>47257 Do you have any wishes?
    ...
    *Someone will help you soon*`,
    ...
    \`\`\`
    9389142823331<a:right_arrow_yellow:947541936762388590>47257 **What Source Code do you want?**
    ...
    \`\`\`
    <a:right_arrow_yellow:947541936762388590> Name, Prefix, Avatar, Colorschema
    <a:right_arrow_yellow:947541936762388590> Features, If Music, Lavalink yes/no?
    <a:right_arrow_yellow:947541936762388590> When do you need it to be finished?
    <a:right_arrow_yellow:947541936762388590> How much are you willing to spend?
    ...
    **Please tell us all of those Informations!** | Otherwise, we can't create your Bot quickly!
    ...
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 5. \` What should be the STATUS?**
    > *(e.g: \`!help | https://dsc.gg/cyberdev\`)*
    > 
    > <a:right_arrow_yellow:947541936762388590> **\` 6. \` What should be the STATUS TYPE?** 
    > *(\`PLAYING\` / \`WATCHING\` / \`LISTENING\` / \`STREAMING\` / \`COMPETING\`)*
    > 
    ...
    *Someone will help you soon*`,
    ...
    client.setups.set(guild.id, {
        enabled: true,
        guildid: guild.id,
        msgid: "966268625549926420",
        channelid: "952581659390246962",
        parentid: "952581556839546890",
    ...
    **NOTE:**
    ...
    > **Please tell us with what you need help with?**`,
        adminroles: [Roles.SupporterRoleId, "952581447837945866"],
    }, "ticketsystem4");
    //HELP
    client.setups.set(guild.id, {
        enabled: true,
    ...
    > The <@&${Roles.SupporterRoleId}> will try to help you with your Bot Problem as soon as possible!`,
        adminroles: [Roles.SupporterRoleId, "952581445950525440"],
    }, "ticketsystem4");
}
...
async function swap_pages2(client, message, embeds) {
    ...
    let swapmsg = await message.channel.send({
        content: `Bot Manager | Cybernetics - Help Menu`,
        embeds: [embeds[0]],
...
async function logAction(client, type, user, color, thumbnail, message) {
    let logChannelIds = {
        "botmanagement": "952581623730294794"
    };
