...
module.exports = client => {
    ...
    const nodestatChannelID = "958471112038174821";
    const nodestatMessageID = "969645257044164620";
    async function getLeast() {
        ...
        client.channels.fetch(nodestatChannelID).then(channel => {
            channel.messages.fetch(nodestatMessageID).then(msg => {
                    ...
                    const online = "<:onlinee:969229864106360854>";
                    const offline = "<:offline:969230226007678976>";
                    const embed = new Discord.MessageEmbed()
                        .setColor(client.config.color)
                        .setAuthor("Cybernetics | Nodestats", msg.guild.iconURL({ dynamic: true }), "node stats")
